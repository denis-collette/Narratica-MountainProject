...
//     const { setAudioSource } = useAudio(); // Ajout essai context
...
//                 if (chapter && chapter.length > 0 && chapter[0].audio_data) {
//                     setAudioSource(chapter[0].audio_data);
//                 }
//             } catch (error) {
...
//         loadData();
//     }, [chapterId, setAudioSource]); // ajout setAudioSource pour avoir le context global encore
